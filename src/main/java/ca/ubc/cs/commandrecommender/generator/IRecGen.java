...
public interface IRecGen {
     ...
     * and {@link #getRecommendationsForUser(ca.ubc.cs.commandrecommender.model.User, ca.ubc.cs.commandrecommender.model.ToolUseCollection, int, int)}
     *
     * @param uses
     */
     ...
     * and before {@link #getRecommendationsForUser(ca.ubc.cs.commandrecommender.model.User, ca.ubc.cs.commandrecommender.model.ToolUseCollection, int, int)}
     */
    void runAlgorithm();
