...
public class LearningRuleRecGenTest extends AbstractRecGenTest {
    ...
    public void testExampleInPaper() {
        ...
        RecommendationCollector r1 = new RecommendationCollector(1, new HashSet<Integer>(Arrays.asList(1,2,1,3,1,4)));
        rec.fillRecommendations(r1);
        Iterator<Integer> i1 = r1.iterator();
        assertEquals(new Integer(5), i1.next());
        assertFalse(i1.hasNext());

        RecommendationCollector r2 = new RecommendationCollector(2, new HashSet<Integer>(Arrays.asList(1,5,1,5,1,3)));
        ...
        RecommendationCollector r3 = new RecommendationCollector(3, new HashSet<Integer>(Arrays.asList(5,6,5,6,5,7)));
